...
import ProductOne from './../DashImage/product/product-01.png';
...
const Product = () => {
  return (
    ...
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="grid grid-cols-6 border-t text-black dark:text-white border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
